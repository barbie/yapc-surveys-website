# This Makefile is for the surveys extension to perl.
#
...
#     ABSTRACT => q[YAPC Conference Surveys]
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.15">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>YAPC Conference Surveys</ABSTRACT>' >> $(DISTNAME).ppd
